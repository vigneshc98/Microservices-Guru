...
//    CustomerRepository customerRepository;
    ...
    @Test
    public void testAllocationFailure() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder().id(beerId).upc("12345").build();
    ...
    public void testAllocatedToCancel() throws JsonProcessingException {
        ...
        Assertions.assertThat(deallocateOrderRequest.getBeerOrderDto().getId()).isEqualTo(savedBeerOrder.getId());
    }
